...
fun main() {
    ...
    val solutionValue = Day11P2().solve(input)
...
private fun <E> ArrayList<E>.haveAllFlashed(): Boolean {
    return this.all { row ->
        var octopiRow = row as ArrayList<Octopus>
        octopiRow.all { octopus ->
               octopus.currentValue == 0
        }
    }
}
...
//private data class Coordinate(val rowIndex: Int, val columnIndex: Int)
//private data class Octopus(var currentValue: Int, var hasFlashedThisStep: Boolean = false) {
